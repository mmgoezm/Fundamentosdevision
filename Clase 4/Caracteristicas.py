...
#SimpleBlobDetector + Descriptor ORB
img_blob = img.copy()
...
keypoints_blob = blob_detector.detect(gray_u8)
keypoints_blob, des_blob = orb.compute(gray_u8, keypoints_blob)
cv2.drawKeypoints(img_blob, keypoints_blob, img_blob, (0, 255, 0), flags=cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
cv2.imshow('Puntos Clave SimpleBlobDetector', img_blob)
